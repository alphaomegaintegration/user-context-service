...
import com.alpha.omega.user.client.auth.HttpBasicAuth;
import com.alpha.omega.user.client.auth.HttpBearerAuth;
import com.alpha.omega.user.client.auth.ApiKeyAuth;
